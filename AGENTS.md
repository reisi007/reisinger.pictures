...
1. **Vision model:** Image descriptions are generated by a vision-capable model in the harness (see skill `content-writing`, section „Captions erzeugen"). If image reading fails, switch to another vision-capable model.
